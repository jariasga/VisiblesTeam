            ...
            foreach (DataGridViewRow row in dataGridView1.Rows)
            {
                ...
                if (s == true)
                {
                    ...
                    if (cantMov <= maxMov)
                    {
                        ...
                        exito2=productionItemWarehouseMovementController.updateData(idProd, idWare, cantMov, "Entrada");
                        if (exito2 == 1)
                        {
                            ...
                            productionItemWarehouseMovementController.insertMovement(idLote, movemenType, idWare, movementReason, documentTypes);
                            exito++;
                        }
                    }
                    else
